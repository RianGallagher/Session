      ...
      >
        <View style={styles.inputContainer}>
          <Image
            ...
            source={{
              uri: 'https://img.icons8.com/dusk/64/000000/music-record.png'
            }}
          />
          <TextInput
        ...
        <View style={styles.inputContainer}>
          <Image
            ...
            source={{
              uri:
                'https://img.icons8.com/color/48/000000/international-music.png'
            }}
          />
          <TextInput
            style={styles.inputs}
        ...
        <TouchableHighlight
          style={[styles.buttonContainer, styles.searchButton]}
          onPress={() => props.songkickSearch()}
        >
